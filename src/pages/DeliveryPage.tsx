      ...
      <div className="flex flex-col md:flex-row flex-1">
        ...
        <div className="w-full md:w-2/3 p-12 flex flex-col justify-center">
          ...
          <p className="text-gray-700 mb-4">
            La Rive D'or® collabore avec notre partenaire de livraison Glovo
            pour vous apporter vos boissons préférées directement chez vous.
          </p>
          <p className="text-gray-700 mb-8">
            Rapide, fiable et simple : sélectionnez vos boissons, passez votre
            commande et laissez Glovo s'occuper du reste!
          </p>
              ...
              <CardContent className="p-0 flex flex-col w-full">
                ...
                <div className="p-4 flex flex-col items-center w-full">
                  <Button
                    ...
                    onClick={() =>
                      window.open("https://www.glovoapp.com/", "_blank")
                    }
                  >
